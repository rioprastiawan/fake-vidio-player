...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-900">
      <header className="relative py-6 bg-gray-800 border-b border-gray-700">
        <div className="container px-4 mx-auto">
          <h1 className="text-3xl font-bold text-white">Video Player</h1>
        </div>
      </header>

      <main className="container relative px-4 py-8 mx-auto">
            ...
            <div className="relative overflow-hidden bg-black rounded-lg shadow-xl aspect-video">
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-center">
                <button
                  ...
                  className="p-8 transition-all duration-300 bg-red-600 rounded-full hover:bg-red-700 hover:scale-110 group"
                >
